...
{
    protected $struct = BlueStar\Payments\Structures\Refund::class;
    ...
    public function test_refundedTransaction() { $this->full( "refundedTransaction", Structures\Transaction::class, true); }
