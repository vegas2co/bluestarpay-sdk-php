...
final class CreateScheduledTransactionWithAccountDetailsTest extends TestCase
{
    public function testWithBankAccount()
    {
        ...
        $account = (new BlueStar\Payments\Structures\Account())
            ->setType(\BlueStar\Payments\AccountTypes::CHECKING)
            ->setNumber('123456')
        ...
        $splitMerchant = (new BlueStar\Payments\Structures\Merchant())
            ->setID(2);
        ...
        $this->assertEquals([
            0 => [
                'URL'  => 'https://api.bluestarpay.com/api/scheduled-transactions',
                'Body' => [
                    'Body' => [
                        "merchant_id"       => 4,
                        "scheduled_at"      => "2018-01-10",
    ...
    public function testWithAccountDetailsFactory()
    {
        ...
        $transaction = BlueStar\Payments\Factories\ScheduleTransaction::withAccountDetails(
            $account,
            $accountHolder,
            $merchant,
            10000,      // Amount
    ...
    public function testWithCreditCard()
    {
        ...
        $account = (new BlueStar\Payments\Structures\Account())
            ->setType(\BlueStar\Payments\AccountTypes::VISA)
